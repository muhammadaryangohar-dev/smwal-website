...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24">
      ...
      <path fill="#34A853" d="M12 24c3.24 0 5.96-1.07 7.95-2.9l-3.88-3c-1.08.72-2.46 1.15-4.07 1.15-3.13 0-5.78-2.11-6.73-4.96H1.26v3.1A12 12 0 0 0 12 24Z" />
      <path fill="#FBBC05" d="M5.27 14.29a7.2 7.2 0 0 1 0-4.58v-3.1H1.26a12 12 0 0 0 0 10.78l4.01-3.1Z" />
      <path fill="#EA4335" d="M12 4.77c1.76 0 3.34.6 4.58 1.79l3.44-3.44C17.95 1.19 15.24 0 12 0A12 12 0 0 0 1.26 6.61l4.01 3.1C6.22 6.88 8.87 4.77 12 4.77Z" />
    </svg>
  );
}
...
export default function Login() {
  ...
  function handleGoogleLogin() {
    // No real OAuth — just simulates a successful Google login for the demo
    navigate("/");
  }
    ...
    <div className="af-page">
      <div className="af-shell">
        ...
        <div className="af-card">
          ...
          <p className="af-card-subtitle">Sign in to continue your guided journey.</p>

          <form onSubmit={handleSubmit} noValidate>
            <div className="af-field">
              <label className="af-label">Email</label>
              <div className="af-input-wrap">
                <span className="af-input-icon"><MailIcon /></span>
                <input
            ...
            <div className="af-field">
              ...
              <div className="af-input-wrap">
                <span className="af-input-icon"><LockIcon /></span>
                <input
            ...
            <div className="af-forgot-row">
              <button type="button" className="af-link-purple" onClick={() => navigate("/forgot-password")}>
                Forgot Password?
              </button>
            </div>

            <button type="submit" className="af-button-primary">Login</button>

            <div className="af-divider">OR</div>

            <button type="button" className="af-button-google" onClick={handleGoogleLogin}>
              <GoogleIcon /> Google
            </button>
          </form>
        </div>
